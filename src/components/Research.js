...
export function ResearchContent() {
  return (
    <ResearchContainer>
      <HeaderSection>
        <h1 style={{ color: '#2c3e50', marginBottom: '20px' }}>Assignment 3: Group 11 — APSC 181 AO3</h1>
        <p>Oscar Begley 33140963, Orgil Mend-Amar 67283671, Phoenix Clark 62968375</p>
        <p>Faculty of applied science University of British Columbia Okanagan campus</p>
        <p>APSC_O 181 Dynamics</p>
        <p>Dr. Fawad Ahmed Najam, Dr. Seach Chyr 'Ernest' Goh</p>
        <p>April 7th 2026</p>
      </HeaderSection>
      ...
      <PaperTitle>Relative motion and dissymmetry of lift:</PaperTitle>
      <Paragraph>
        The handbook titled “Aerodynamics of flight” defines dissymmetry of lift in a helicopter as the “unequal lift between advancing and retreating halves of the rotor disk caused by the different wind flow velocity across each half.” [7]. When a helicopter is moving forward it does so via cyclic feathering; altering the pitch angle so that the blades change angles within rotation, allowing movement in any horizontal direction. Which is done via a cyclic control stick. Doing so, the rotor disk has an advancing and retreating half as it performs a circular cylindrical motion: Relative wind occurs on both halves, with its speed increasing on the advancing side (Vrot + Vhelicopter ) and decreasing on the retreating side due to the forward motion of the helicopter. Resulting in more lift on the advancing side creating a dissymmetry of lift that can move the helicopter left or right depending on the rotation of the rotor disks. To counteract this, the area of attack (AOA) needs to be altered simply by adjusting the mobility of the blades to flap up or down in circular motion; adding a downflap velocity for the retreating half , and up-flap velocity for advancing half, which is done through controlled hinges on the rotor disks.
      </Paragraph>

      <PaperTitle>Conservations of angular momentum and the anti-torque system</PaperTitle>
      <Paragraph>
        The webpage “Helicopters: the conversation of angular momentum.” defines the law of conservation of angular momentum as when a body is in rotation, it maintains its rotational momentum unless acted upon an external torque [8]. In the case of helicopters, the engine causes the main rotor to spin and generate torque, creating lift, but by itself, the fuselage (main body) would likely spin in the opposite direction of the main rotor. This is due to Newton’s third law that states for every action there is an equal and opposite reaction. To counteract this torque, the anti-toque or NOTAR system is composed of a small external rotor attached to the tail, perpendicular to the plane of rotation of the main rotor, generating enough torque to keep the fuselage stable in flight.
      </Paragraph>

      <PaperTitle>Collective control</PaperTitle>
      <Paragraph>
        The collective control changes the pitch angle of each blade on the rotor, where raising each blade results in an increase of AOA, which generates lift and drag due to relative wind acting the collective blades, as well as a decrease in rpm on the main rotor. With the opposite occurring in a decrease in pitch angle. [9]
      </Paragraph>
      <Paragraph>
        The research paper “Modelling and Simulation of Helicopter Swashplate Collective Control Response in UAV Applications.” addresses how modern helicopters function: That simply changing the speed of the rotor using BLDC & servo motors within a modern flybarless system, is more efficient than manually changing the pitch angle from the collective control, used in the early helicopter designs. This is done by performing simulations in MATLab-Simulink[10].They perform these simulations, in reference to kinematic relations such as the angular velocity of the motor shaft; wshaft = wmotor , and more advanced kinematic relations such as the vertical displacement of the swashplate in reference to the pitch angle (rp) and servo angle (s);z = rps180, as well as more complicated lift calculations. Their results showcase that manually changing the pitch angle is slower, compared to compact automatic electronic sensors and systems in BLDC & servo motors: Improving overall responsiveness as their finding showcase that the lift is quadratically proportional to the motors speed.
      </Paragraph>
      ...
      <ReferenceSection>
        ...
        <RefItem>[7] A. F. Instructor, “What is Dissymmetry of Lift?” https://blog.flyhaa.com/blog/what-is-dissymmetry-of-lift</RefItem>
        <RefItem>[8] A. V. O. Prezi, “Helicopters: the conversion of angular momentum,” prezi.com. https://prezi.com/lxcqbqmr4y5j/helicopters-the-conversion-of-angular-momentum/#:~:text=in%20Helicopters,Velocity%20is%20tangent.</RefItem>
        <RefItem>[9] W. J. Boynes. Britannica, “Control Functions in Helicopters,”. https://www.britannica.com/technology/helicopter/Control-functions</RefItem>
        <RefItem>[10] H. Vishal, M. Pratik, C. Chyawan, K. M, “Modelling and Simulation of Helicopter Swashplate Collective Control Response in UAV Applications.” 8th IEEE International Conference on Computational System and Information Technology for Sustainable Solutions, CSITSS 2024, 2024. [Online] Available: Compendex</RefItem>
      </ReferenceSection>
    </ResearchContainer>
  );
}
